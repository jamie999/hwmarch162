...
-(void)addBlocksFromArray:(NSArray*)blocks {
    ...
    for (NSDictionary *block in blocks) {
        ...
        blockSprite.physicsBody.categoryBitMask = CNPhysicsCategoryCat;
        blockSprite.physicsBody.collisionBitMask = CNPhysicsCategoryCat | CNPhysicsCategoryCat;
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    [self.physicsWorld enumerateBodiesAtPoint:location usingBlock:
     ^(SKPhysicsBody *body, BOOL *stop) { // 3
